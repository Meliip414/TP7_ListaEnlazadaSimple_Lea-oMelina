...
void buscar_max_min(tlista lista){
	pnodo i;
	int mayor=lista.inicio->dato, menor=lista.inicio->dato;
	if(lista .inicio!= NULL){
		...
		cout<<"El menor valor almacenado en la lista es: "<<menor<<endl;
		cout<<"El mayor valor almacenado en la lista es: "<<mayor<<endl;
	}
}
...
int main(){
    ...
    cout << "\nBuscando menor y mayor elemento en la lista..."<<endl;
    buscar_max_min(lista);
